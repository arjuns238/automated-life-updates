...
export default function Profile() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6 bg-slate-900 text-slate-200 rounded-lg shadow-md">
      {/* Header with editable avatar */}
      <div className="flex items-center space-x-4">
        <div className="relative">
          <div onClick={handleAvatarClick} className="relative cursor-pointer group">
            <Avatar className="h-20 w-20 bg-slate-800">
              {avatarUrl ? (
        ...
        <div>
          ...
          <p className="text-slate-400">Click avatar to change</p>
        </div>
      ...
      <Card className="bg-slate-800 text-slate-200">
        ...
        <CardContent className="space-y-4">
          <div>
            <Label htmlFor="email" className="flex items-center gap-2 text-slate-400">
              <Mail className="h-4 w-4" /> Email
            </Label>
            <Input id="email" type="email" value={user?.email || ""} disabled className="bg-slate-700 text-slate-200" />
          </div>

          <div>
            <Label htmlFor="username" className="flex items-center gap-2 text-slate-400">
              <User className="h-4 w-4" /> Username
            </Label>
            <Input id="username" value={username} onChange={(e) => setUsername(e.target.value)} className="bg-slate-700 text-slate-200" />
          </div>

          <div>
            <Label htmlFor="displayName" className="text-slate-400">Display Name</Label>
            <Input id="displayName" value={displayName} onChange={(e) => setDisplayName(e.target.value)} className="bg-slate-700 text-slate-200" />
          </div>

          <div>
            <Label htmlFor="password" className="flex items-center gap-2 text-slate-400">
